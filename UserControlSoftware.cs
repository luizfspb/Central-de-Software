...
public class UserControlSoftware : UserControl
{
    ...
    private void InitializeComponent()
    {
        ...
        mainPanel.Controls.Add(CriarBotoesSoftware("Visualizador Apollo", "apollo.png"));
    ...
    private async Task Instalar(string nome)
    {
        ...
        switch (nome)
        {
            ...
            case "Office 365":
                ...
                break;
            case "Visualizador Apollo":
                // Certifique-se de que VisualizadorApollo.exe está como Embedded Resource
                resourceName = "Central_de_Software.softwares.VisualizadorApollo.exe";
                tempName = "VisualizadorApollo.exe";
                break;
        }
        if (resourceName != null && tempName != null)
        {
            ...
            {
                MessageBox.Show($"Erro ao instalar {nome}: {ex.Message}\nVerifique se o arquivo está como Embedded Resource e o nome está correto.", "Erro", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        else if (nome == "Visualizador Apollo")
        {
            MessageBox.Show($"Recurso VisualizadorApollo.exe não encontrado. Certifique-se de que o arquivo está como Embedded Resource.", "Erro", MessageBoxButtons.OK, MessageBoxIcon.Error);
        }
    }
